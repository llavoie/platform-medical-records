...
public interface MrsActionProxyService {
    ...
    void createEncounter(String motechId, String facilityId, String userId, // NO CHECKSTYLE ParameterNumber
                         String providerId, DateTime encounterDate, String encounterType, DateTime observationDate,
                         String conceptName, String patientId, String value);

    void createFacility(String name, String country, String region, String countyDistrict, String stateProvince);

    void updateFacility(String facilityId, String name, String country, String region, String countyDistrict,
                        String stateProvince);

    void deleteFacility(String facilityId);

    void createPerson(String personId, String firstName, String middleName, // NO CHECKSTYLE ParameterNumber
    ...
    void updatePerson(String personId, String firstName, String middleName, // NO CHECKSTYLE ParameterNumber
                      String lastName, String preferredName, String address, DateTime dateOfBirth,
                      String birthDateEstimated, Integer age, String gender, String dead, DateTime deathDate);

    void removePerson(String personId, String firstName, String middleName, // NO CHECKSTYLE ParameterNumber
                      String lastName, String preferredName, String address, DateTime dateOfBirth,
                      String birthDateEstimated, Integer age, String gender, String dead, DateTime deathDate);
